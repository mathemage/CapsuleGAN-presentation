...
\subtitle{by A. Jaiswal, W. AbdAlmageed, Y. Wu and P. Natarajan\\
(arXiv:1802.06167)}
\author{presented by Karel Ha}
\date{22\textsuperscript{nd} May 2018}
...
\begin{document}
  {
    \usebackgroundtemplate{
      \includegraphics[width=\paperwidth]{../img/capsgan_cifar10_randomly_generated.png}
    }
    \maketitle
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \subsection{Experiments}
  {
    ...
    \begin{frame}{Generative Adversarial Metrics\\
      ...
      \pause
      \begin{itemize}[<+- | alert@+>]
        \item CapsuleGAN $>$ convolutional GAN (on MNIST)
        \item comparable on~CIFAR-10.
      \end{itemize}
    \end{frame}
