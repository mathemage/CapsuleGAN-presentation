...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \subsection{What is a capsule?}
  {
    ...
    \begin{frame}{The Previous Version \\
        \tiny ``Transforming Auto-Encoders'' [\cite{Hinton2011transforming}]}
      \pause
      \begin{center}
        \includegraphics[width=\linewidth]{../img/transforming-auto-encoder.png}
        \tiny For illustration, three capsules of a~transforming auto-encoder (that models translation).
      \end{center}
    \end{frame}
  }
