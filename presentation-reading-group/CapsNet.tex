    ...
    \begin{frame}{Part-Whole Geometric Relationships \\
      ...
      \begin{enumerate}[a)]
        \item arrays of~geometrical objects
          \pause
        \item matrices representing their relative positions and orientations (so-called \textbf{``poses''})
      \end{enumerate}
    \end{frame}
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  {
    % TODO citations
    \setbeamertemplate{frame footer}{\colorcite TODO %[\cite{Sabour2017dynamic}]
    }

    \begin{frame}{What Is a Capsule?}
      % TOODO pic from transf autoencoder
    \end{frame}
  }
