...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \subsection{Algorithm}
  {
    ...
    \begin{frame}{Routing by an Agreement}
      \begin{center}
        \includegraphics[height=.55\textheight]{../img/routing-agreement.png}
        \pause

        \includegraphics[height=.3\textheight]{../img/routing-weights.png}
      \end{center}
    \end{frame}
  }

  {
    ...
    \begin{frame}{Squashing}
      ...
      \pause
      \begin{center}
        \includegraphics[width=\textwidth]{../img/squashing.png}
      \end{center}
    \end{frame}
