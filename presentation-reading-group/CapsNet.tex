...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \section{Motivation}
  {
    \setbeamertemplate{frame footer}{TODO cite https://medium.com/ai³-theory-practice-business/understanding-hintons-capsule-networks-part-i-intuition-b4b559d1159b}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  {
    \setbeamertemplate{frame footer}{TODO cite Aurelion}%{[\cite{Sabour2017dynamic}]}
  ...
  {
    \setbeamertemplate{frame footer}{[TODO cite Hinton's talk: https://youtu.be/rTawFwUvnLE]}
  ...
  {
    \setbeamertemplate{frame footer}{[TODO cite https://github.com/naturomics/CapsNet-Tensorflow]}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \subsection{Loss}
  {
    ...
    \begin{frame}{Margin Loss \\
      ...
      \pause
      \begin{itemize}[<+- | alert@+>]
        \item $T_k = 1$ iff a digit of class $k$ is present
        \item $m^{+} = 0.9$
        \item $m^{-} = 0.1$
